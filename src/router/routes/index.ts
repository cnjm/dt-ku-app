...
const viewsFile = import.meta.globEager("/src/views/game/**/index.vue");
const viewsFileAsync = import.meta.glob("/src/views/game/**/index.vue");
...
export const basicRoutes = [RootRoute, NETWORK_ERROR_ROUTE, PAGE_NOT_FOUND_ROUTE];
