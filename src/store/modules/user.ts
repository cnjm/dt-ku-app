...
import { GetUserInfoModel, LoginParams } from "../../api/user/model/user.model";
...
import { doLogout, getUserInfo, loginApi } from "../../api/user/user";
import { isArray } from "/@/utils/internal/isType";
import { useMessage } from "/@/hooks/web/useMessage";
import { ddGetUserInfo } from "/@/utils/dingtalk";
...
interface UserState {
  ddConfigStatus: boolean;
  ddUserInfo: Nullable<DdUserInfo>;
...
export const useUserStore = defineStore({
  ...
  actions: {
    ...
    // 获取钉钉用户信息
    async getDdUserInfo(): Promise<void> {
